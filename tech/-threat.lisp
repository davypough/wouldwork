...
;;; to exclude an unsafe destination outright -- walk, jump-to, and use-ladder all do.  But
...
;;; exists, regardless of which relocation technologies (walkability, jump, ladder, the
...
(define-update enforce-threat-safety! ()
  ...
  ;; isn't safe -- however it got there, whether by a precondition-gated walk/jump-to/
