...
;;;              angled-gears)  --  what can be positioned at a fixed location; subtypes
...
(define-types
  fixed-position-object (either plate ladder floor-gears wall-gears angled-gears))  ;what can be positioned at a fixed location
