...
(define-action move-D  ;move down-tile
  ...
  (do (bind (loc ?tile $row $col))
      (bind (emptys $emptys))
      (if (and (assign $empty1-coord (check-coord $row (+ $col 2)))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (1+ $row) (1+ $col)))
               (member $empty2-coord $emptys :test #'equal))
        (assert (assign $direction 'right)
                ...
                (assign $new-emptys (sort-coords $new-emptys))
                (emptys $new-emptys)
                (loc ?tile $row (1+ $col))))
      (if (and (assign $empty1-coord (check-coord $row (- $col 2)))
               (member $empty1-coord $emptys :test #'equal)
        ...
        (assert (assign $direction 'left)
                ...
                (emptys $new-emptys)
                (loc ?tile $row (1- $col))))
      (if (and (assign $empty1-coord (check-coord (+ $row 1) (- $col 1))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (+ $row 2) $col))
               (member $empty2-coord $emptys :test #'equal)
               (assign $empty3-coord (check-coord (+ $row 1) (1+ $col)))
               (member $empty3-coord $emptys :test #'equal))
        (assert (assign $direction 'down)
                (assign $new-emptys (copy-list $emptys))
                (alexandria:deletef $new-emptys $empty1-coord :test #'equal)
                (alexandria:deletef $new-emptys $empty2-coord :test #'equal)
                ...
                (emptys $new-emptys)
                (loc ?tile (1+ $row) $col)))
      (if (and (assign $empty1-coord (check-coord (1- $row) (1- $col)))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (1- $row) $col))
               (member $empty2-coord $emptys :test #'equal))
               (assign $empty3-coord (check-coord (1- $row) (1+ $col)))
               (member $empty3-coord $emptys :test #'equal))
        (assert (assign $direction 'up)
                (assign $new-emptys (copy-list $emptys))
                (alexandria:deletef $new-emptys $empty1-coord :test #'equal)
                (alexandria:deletef $new-emptys $empty2-coord :test #'equal)
                (alexandria:deletef $new-emptys $empty3-coord :test #'equal)
...
(define-action move-U
  ...
  (do (bind (loc ?tile $row $col))
      ...
      (if (and (assign $empty1-coord (check-coord (+ $row 1) (- $col 1))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (+ $row 1) $col))
               (member $empty2-coord $emptys :test #'equal)
               (assign $empty3-coord (check-coord (+ $row 1) (1+ $col)))
               (member $empty3-coord $emptys :test #'equal))
        (assert (assign $direction 'down)
                ...
                (emptys $new-emptys)
                (loc ?tile (1+ $row) $col)))
      (if (and (assign $empty1-coord (check-coord (- $row 2) $col))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (1- $row) (1+ $col)))
               (member $empty2-coord $emptys :test #'equal))
               (assign $empty3-coord (check-coord (1- $row) (1- $col)))
...
(define-action move-R
  ...
  (do (bind (loc ?tile $row $col))
      ...
      (if (and (assign $empty1-coord (check-coord (+ $row 1) (+ $col 1))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord $row (+ $col 2)))
               (member $empty2-coord $emptys :test #'equal)
               (assign $empty3-coord (check-coord (- $row 1) (1+ $col)))
               (member $empty3-coord $emptys :test #'equal)))
        (assert (assign $direction 'right)
                ...
                (emptys $new-emptys)
                (loc ?tile $row (1+ $col))))
      (if (and (assign $empty1-coord (check-coord (+ $row 1) (1- $col)))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord $row (1- $col)))
               (member $empty2-coord $emptys :test #'equal))
               (assign $empty3-coord (check-coord (1- $row) (1- $col)))
...
(define-action D-right  ;move D-tile right
  ...
  (and (bind (loc ?tile $loc))
       (bind (emptys $emptys))
       (assign $empty1-coord (rel-coord $loc 0 2))
       (gethash $empty1-coord $emptys)
       (assign $empty2-coord (rel-coord $loc 1 1))
       (gethash $empty2-coord $emptys))
  (?tile)
  (assert (loc ?tile (rel-coord $loc 0 1))
          (assign $new-emptys (alexandria:copy-hash-table $emptys))
...
(define-action D-down
  ...
  (and (bind (loc ?tile $loc))
       (bind (emptys $emptys))
       (assign $empty1-coord (rel-coord $loc 1 -1))
       (gethash $empty1-coord $emptys)
       (assign $empty2-coord (rel-coord $loc 2 0))
       (gethash $empty2-coord $emptys)
       (assign $empty3-coord (rel-coord $loc 1 1))
...
(define-action D-up
  ...
  (and (bind (loc ?tile $loc))
       ...
       (assign $empty1-coord (rel-coord $loc -1 -1))
       (gethash $empty1-coord $emptys)
       (assign $empty2-coord (rel-coord $loc -1 0))
       (gethash $empty2-coord $emptys)
       (assign $empty3-coord (rel-coord $loc -1 1))
       (gethash $empty3-coord $emptys))
  (?tile)
...
(define-action U-right  ;move u-tile right
  ...
  (and (bind (loc ?tile $loc))
       ...
       (assign $empty1-coord (rel-coord $loc -1 1))
       (gethash $empty1-coord $emptys)
       (assign $empty2-coord (rel-coord $loc 0 2))
       (gethash $empty2-coord $emptys))
  (?tile)
  (assert (loc ?tile (rel-coord $loc 0 1))
          (assign $new-emptys (alexandria:copy-hash-table $emptys))
...
(define-action R-up
  ...
  (and (bind (loc ?tile $loc))
       (bind (emptys $emptys))
       (assign $empty1-coord (rel-coord $loc -2 0))
       (gethash $empty1-coord $emptys)
       (assign $empty2-coord (rel-coord $loc -1 1))
       (gethash $empty2-coord $emptys))
  (?tile)
...
(define-action R-left
  ...
  (and (bind (loc ?tile $loc))
       ...
       (assign $empty1-coord (rel-coord $loc -1 -1))
       (gethash $empty1-coord $emptys)
       (assign $empty2-coord (rel-coord $loc 0 -1))
       (gethash $empty2-coord $emptys)
       (assign $empty3-coord (rel-coord $loc 1 -1))
       (gethash $empty3-coord $emptys))
  (?tile)
...
(define-action Y-down
  ...
  (and (bind (loc ?tile $loc))
       (bind (emptys $emptys))
       (assign $empty1-coord (rel-coord $loc 2 -1))
       (gethash $empty1-coord $emptys)
       (assign $empty2-coord (rel-coord $loc 2 0))
       (gethash $empty2-coord $emptys)
       (assign $empty3-coord (rel-coord $loc 1 1))
...
(define-action Y-left
  ...
  (and (bind (loc ?tile $loc))
       (bind (emptys $emptys))
       (assign $empty1-coord (rel-coord $loc 0 -1))
       (gethash $empty1-coord $emptys)
       (assign $empty2-coord (rel-coord $loc 1 -2))
       (gethash $empty2-coord $emptys))
  (?tile)
  (assert (loc ?tile (rel-coord $loc 0 -1))
          (assign $new-emptys (alexandria:copy-hash-table $emptys))
...
(define-init-action init-emptys
  0
  ()
  (assign $ht (make-hash-table :test #'equal))
  ()
