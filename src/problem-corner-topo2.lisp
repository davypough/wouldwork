...
;;; beam-relay; crossing-based beam cutting (no coordinate geometry, just authored
;;; crossing/sightline facts) is supplied by beam-crossing.  Only normal-mode gate
