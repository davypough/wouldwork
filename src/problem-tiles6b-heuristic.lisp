...
(define-action move-L  ;move L-tile
  ...
  (do (bind (loc ?tile $row $col))
      (bind (emptys $emptys))
      (if (and (assign $empty1-coord (check-coord $row (+ $col 1)))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (+ $row 1) (+ $col 2)))
      ...
      (if (and (assign $empty1-coord (check-coord $row (- $col 1)))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (+ $row 1) (- $col 1)))
               (member $empty2-coord $emptys :test #'equal))
      ...
      (if (and (assign $empty1-coord (check-coord (+ $row 2) $col))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (+ $row 2) (+ $col 1)))
               (member $empty2-coord $emptys :test #'equal))
...
(define-action move-GUN
  ...
  (do (bind (loc ?tile $row $col))
      (bind (emptys $emptys))
      (if (and (assign $empty1-coord (check-coord $row (+ $col 3)))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (+ $row 1) (+ $col 2)))
               (member $empty2-coord $emptys :test #'equal)
               (assign $empty3-coord (check-coord (+ $row 2) (+ $col 1)))
      ...
      (if (and (assign $empty1-coord (check-coord $row (- $col 1)))
        ...
        (assert (assign $direction 'left)
                ...
                (emptys (sort-coords $new-emptys))
                (loc ?tile $row (- $col 1))))
      (if (and (assign $empty1-coord (check-coord (+ $row 1) (+ $col 2)))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (+ $row 3) $col))
               (member $empty2-coord $emptys :test #'equal)
               (assign $empty3-coord (check-coord (+ $row 2) (+ $col 1)))
               (member $empty3-coord $emptys :test #'equal))
        (assert (assign $direction 'down)
      ...
      (if (and (assign $empty1-coord (check-coord (- $row 1) (+ $col 2)))
               ...
               (assign $empty2-coord (check-coord (- $row 1) $col))
               (member $empty2-coord $emptys :test #'equal)
               (assign $empty3-coord (check-coord (- $row 1) (+ $col 1)))
               (member $empty3-coord $emptys :test #'equal))
        (assert (assign $direction 'up)
                (assign $new-emptys (copy-list $emptys))
                (alexandria:deletef $new-emptys $empty1-coord :test #'equal)
...
(define-action move-UP
  ...
  (do (bind (loc ?tile $row $col))
      ...
      (if (and (assign $empty1-coord (check-coord $row (+ $col 1)))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (+ $row 1) (+ $col 3)))
               (member $empty2-coord $emptys :test #'equal)
        (assert (assign $direction 'right)
                (assign $new-emptys (copy-list $emptys))
                (alexandria:deletef $new-emptys $empty1-coord :test #'equal)
      ...
      (if (and (assign $empty1-coord (check-coord $row (- $col 1)))
        ...
        (assert (assign $direction 'left)
                ...
                (emptys (sort-coords $new-emptys))
                (loc ?tile $row (- $col 1))))
      (if (and (assign $empty1-coord (check-coord (+ $row 2) (+ $col 2))
               (member $empty1-coord $emptys :test #'equal)
               (assign $empty2-coord (check-coord (+ $row 2) $col))
               (member $empty2-coord $emptys :test #'equal)
               (assign $empty3-coord (check-coord (+ $row 2) (- $col 1)))
               (member $empty3-coord $emptys :test #'equal)
               (assign $empty4-coord (check-coord (+ $row 2) (+ $col 1)))
      ...
      (if (and (assign $empty1-coord (check-coord $row (- $col 1)))
               ...
               (assign $empty2-coord (check-coord (- $row 1) $col))
               (member $empty2-coord $emptys :test #'equal))
               (assign $empty3-coord (check-coord $row (+ $col 1)))
               (member $empty3-coord $emptys :test #'equal))
               (assign $empty4-coord (check-coord $row (+ $col 2)))
               (member $empty4-coord $emptys :test #'equal))
        (assert (assign $direction 'up)
                (assign $new-emptys (copy-list $emptys))
                (alexandria:deletef $new-emptys $empty1-coord :test #'equal)
  ...
  (do (bind (loc ?tile $row $col))
      ...
      (if (and (assign $empty1-coord (check-coord $row (- $col 1)))
        ...
        (assert (assign $direction 'left)
                ...
                (emptys (sort-coords $new-emptys))
                (loc ?tile $row (- $col 1))))
      (if (and (assign $empty1-coord (check-coord (+ $row 3) $col))
               (member $empty1-coord $emptys :test #'equal))
        (assert (assign $direction 'down)
                (assign $new-emptys (copy-list $emptys))
                (alexandria:deletef $new-emptys $empty1-coord :test #'equal)
